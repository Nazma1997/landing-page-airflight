...
export default function Logo(){
  return(
    <div className='lg:flex bg-blue-900	justify-around p-5 '>
       ...
       <p className='text-3xl font-medium text-white m-1'>Accueil</p>
       <p className='text-2xl  text-white font-normal m-1'>Avoins</p>
       <p className='text-2xl  text-white font-normal m-1'>Services</p>
       <p className='text-2xl font-normal  text-white m-1'>Qui somme Nous</p>
       <p className='text-2xl font-normal text-white m-1'>Contactez Nous</p>
