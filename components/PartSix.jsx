...
import img1 from '../images/part-6.jpg';
  ...
  return(
    <div className='2xl:flex md:flex  2xl:mx-20 md:mx-5 xs:mx-1 mt-24'>
       ...
       <div className='  xs:mt-5 xs:ml-2 2xl:mt-32'>
          <p className='text-2xl font-bold text-blue-500'>Location hélicoptère</p>
          ...
          <p className='text-xl font-bold text-blue-500 mx-1 my-5'>Nos hélicopters</p>
